...
const operatorId = "0.0.3760069"
// const operatorKey = PrivateKey.fromStringDer(process.env.NEXT_PUBLIC_HEDERA_ACCOUNT_PRIV_KEY!);
const operatorKey = PrivateKey.fromStringDer("3030020100300706052b8104000a042204200cd58feff4ad2a43ce0022325ad1e16effa1832db9f72cca05e272695c212cdf")
